import { Daemon, optionsForPlotter, defaultsForPlotter, PlotterName } from '@greenbtc-network/api';
import type { Plotter, PlotterMap, PlotterApi } from '@greenbtc-network/api';
