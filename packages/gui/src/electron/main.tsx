...
import { NFTInfo } from '@greenbtc-network/api';
...
import AppIcon from '../assets/img/greenbtc64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import greenbtcEnvironment from '../util/greenbtcEnvironment';
...
// Set the userData directory to its location within GREENBTC_ROOT/gui
setUserDataDir();
...
const ensureCorrectEnvironment = () => {
  ...
  if (!greenbtcEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
    app.quit();
    return false;
  }
...
if (ensureSingleInstance() && ensureCorrectEnvironment()) {
  ...
  const createWindow = async () => {
    if (manageDaemonLifetime(NET)) {
      greenbtcEnvironment.startGreenBTCDaemon();
    }
...
function getMenuTemplate() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'GreenBTC Blockchain Wiki' }),
          click: () => {
            openExternal('https://github.com/greenbtc/greenbtc-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/greenbtc/greenbtc-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/greenbtc/greenbtc-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/greenbtc/greenbtc-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/greenbtc/greenbtc-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/greenbtc');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/greenbtc_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // GreenBTC Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'GreenBTC' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About GreenBTC Blockchain' }),
          click: () => {
            openAbout();
          },
        },
