import { Flex, MenuItem, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@greenbtc-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      <Grid item>
        <Flex flexDirection="column" gap={1}>
          ...
          <SettingsText>
            <Trans>
              WalletConnect enables a decentralized app on the GreenBTC blockchain to communicate and make requests directly
              to a GreenBTC wallet.
            </Trans>
          </SettingsText>
        </Flex>
      </Grid>
                ...
                <Grid item container style={{ width: '400px' }} gap={2}>
                  <SettingsText>
                    <Trans>
                      ...
                      command issued by the Dapp will require confirmation in the GreenBTC wallet.
                    </Trans>
                  </SettingsText>
                </Grid>
              </>
