...
import { useGetDIDQuery, useGetDIDNameQuery, useSetDIDNameMutation } from '@greenbtc-network/api-react';
import { Color, CopyToClipboard, Flex, Suspender, Tooltip, truncateValue } from '@greenbtc-network/core';
