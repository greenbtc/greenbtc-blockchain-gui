import { useGetAutoWithdrawStakeQuery, useSetAutoWithdrawStakeMutation } from '@greenbtc-network/api-react';
import { Flex, Form, ButtonLoading, Fee, SettingsLabel, greenbtcToMojo, mojoToGreenBTC, toExponential } from '@greenbtc-network/core';
...
export default function SettingsStake(props) {
  ...
  const autoWithdrawStakeFee = toExponential(
    withdrawStake?.txFee ? mojoToGreenBTC(withdrawStake.txFee).toNumber() : 0
  );
