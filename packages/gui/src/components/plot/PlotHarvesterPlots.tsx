...
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@greenbtc-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@greenbtc-network/core';
