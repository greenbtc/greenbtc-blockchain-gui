...
import { Button, CardHero, Flex, Link, useOpenDialog } from '@greenbtc-network/core';
import { Plots } from '@greenbtc-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn GreenBTC. &nbsp;
