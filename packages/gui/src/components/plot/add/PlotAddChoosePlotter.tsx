...
import { CardStep, Select, StateColor } from '@greenbtc/core';
import { useGetPlottersQuery } from '@greenbtc/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@greenbtc/api';
import type { Plotter, PlotterMap } from '@greenbtc/api';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default GreenBTC Proof of Space plotter. If unsure,
            use the default GreenBTC Proof of Space plotter.
        </Trans>
      </Typography>
