import { defaultPlotter, PlotterName } from '@greenbtc-network/api';
import type { Plotter, PlotterMap } from '@greenbtc-network/api';
import { useGetPlottersQuery } from '@greenbtc-network/api-react';
import { CardStep, Select, StateColor } from '@greenbtc-network/core';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function getDisplayablePlotters(p: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => (a === PlotterName.GREENBTCPOS ? -1 : a.localeCompare(b)));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default GreenBTC Proof of Space plotter. If unsure, use the default GreenBTC Proof of Space plotter.
        </Trans>
      </Typography>
