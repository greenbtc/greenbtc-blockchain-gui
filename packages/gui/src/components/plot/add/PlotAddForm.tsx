...
import { defaultPlotter, toBech32m, fromBech32m } from '@greenbtc/api';
import {
  useStartPlottingMutation,
  useCreateNewPoolWalletMutation,
} from '@greenbtc/api-react';
import { useForm, SubmitHandler } from 'react-hook-form';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@greenbtc/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.GREENBTCPOS),
  });
