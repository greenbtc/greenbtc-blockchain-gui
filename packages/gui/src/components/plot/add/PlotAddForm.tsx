import { defaultPlotter, toBech32m, fromBech32m, WalletCreatePool } from '@greenbtc-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@greenbtc-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@greenbtc-network/core';
