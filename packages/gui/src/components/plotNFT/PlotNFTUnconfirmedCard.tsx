import type { UnconfirmedPlotNFT } from '@greenbtc-network/api';
import { useGetTransactionQuery } from '@greenbtc-network/api-react';
import { Flex, Link, Loading } from '@greenbtc-network/core';
