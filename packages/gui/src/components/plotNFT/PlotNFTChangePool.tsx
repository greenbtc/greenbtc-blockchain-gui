import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@greenbtc-network/api-react';
import { Flex, State, Loading, StateTypography } from '@greenbtc-network/core';
