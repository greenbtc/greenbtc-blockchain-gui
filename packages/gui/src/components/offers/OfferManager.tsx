import { OfferTradeRecord, toBech32m } from '@greenbtc-network/api';
import { useCancelOfferMutation, useGetWalletsQuery } from '@greenbtc-network/api-react';
import {
  Button,
  Card,
  CardHero,
...
function OfferList(props: OfferListProps) {
  ...
  const testnet = useCurrencyCode() === 'TGBTC';
                  ...
                  <Flex flexDirection="column" gap={4} height="100%">
                    <Flex flexDirection="column" gap={2} flexGrow={1}>
                      ...
                      <Typography variant="body1" color="textSecondary">
                        <Trans>
                          Create a file that you can use to trade GBTC, GreenBTC Asset Tokens, or NFTs with no counter-party
                          risk.
                        </Trans>
                      </Typography>
                    </Flex>
...
export function CreateOffer() {
  ...
  const testnet = currencyCode === 'TGBTC';
