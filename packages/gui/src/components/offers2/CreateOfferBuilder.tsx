...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@greenbtc-network/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@greenbtc-network/core';
