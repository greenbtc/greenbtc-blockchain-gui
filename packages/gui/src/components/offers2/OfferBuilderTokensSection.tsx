...
import { Tokens } from '@greenbtc/icons';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@greenbtc/core';
import { WalletType } from '@greenbtc/api';
import type { Wallet } from '@greenbtc/api';
import { useGetWalletsQuery } from '@greenbtc/api-react';
...
export default function OfferBuilderTokensSection(
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={
        <Trans>GreenBTC Asset Tokens (CATs) are tokens built on top of GBTC</Trans>
      }
