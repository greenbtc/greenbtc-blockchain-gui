...
import { useGetWalletsQuery } from '@greenbtc-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@greenbtc-network/core';
import { Tokens } from '@greenbtc-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>GreenBTC Asset Tokens (CATs) are tokens built on top of GBTC</Trans>}
