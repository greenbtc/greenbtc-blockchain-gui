import { Button, Flex } from '@greenbtc-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The GreenBTC application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                GreenBTC services version: {backV}
                <br />
                GreenBTC application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the GreenBTC application and stop all GreenBTC services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
