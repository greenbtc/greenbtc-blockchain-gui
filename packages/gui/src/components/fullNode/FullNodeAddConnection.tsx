import { useOpenFullNodeConnectionMutation } from '@greenbtc-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@greenbtc-network/core';
