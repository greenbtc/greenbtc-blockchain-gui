import { fromBech32m } from '@greenbtc-network/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@greenbtc-network/api-react';
import { Button, Flex, Form, TextField, Loading } from '@greenbtc-network/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25GBTC reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
