...
import { Truncate, Button, Color, useOpenDialog, AlertDialog, Flex, More, MenuItem } from '@greenbtc-network/core';
import { Burn as BurnIcon } from '@greenbtc-network/icons';
