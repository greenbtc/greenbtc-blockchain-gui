import { OfferCoinOfInterest, OfferSummaryRecord } from '@greenbtc-network/api';
import { useGetOffersCountQuery, useGetAllOffersQuery } from '@greenbtc-network/api-react';
