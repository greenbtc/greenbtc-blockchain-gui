import type { OfferSummaryRecord, Wallet } from '@greenbtc-network/api';
import { useTakeOfferMutation } from '@greenbtc-network/api-react';
import { AlertDialog, greenbtcToMojo, useOpenDialog, useShowError } from '@greenbtc-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? greenbtcToMojo(fee) : new BigNumber(0);
