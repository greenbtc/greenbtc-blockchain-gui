import api, { store, useGetLoggedInFingerprintQuery } from '@greenbtc-network/api-react';
import { useOpenDialog, useAuth } from '@greenbtc-network/core';
...
const log = debug('greenbtc-gui:walletConnectCommand');
