...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of greenbtc', () => {
      const result = units.getUnit('greenbtc');
    ...
    it('gets unit of greenbtc using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of greenbtc', () => {
      const result = units.getDisplay('greenbtc');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('greenbtc', 9);

      const result = units.getUnit('greenbtc');

      expect(result).toEqual(9);

      units.setUnit('greenbtc', 1);
    });
  });
  describe('#setDisplay', () => {
