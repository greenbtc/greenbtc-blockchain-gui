import type { KeyData } from '@greenbtc-network/api';
import {
  usePrefs,
...
import { GreenBTCBlack, Coins } from '@greenbtc-network/icons';
        ...
        {isLoadingPublicKeys ? (
          ...
          <>
            ...
            <Flex alignItems="center" flexDirection="column">
              ...
              >
                <Trans>Create a new wallet key to get started with GreenBTC.</Trans>
              </Typography>
              <Button
