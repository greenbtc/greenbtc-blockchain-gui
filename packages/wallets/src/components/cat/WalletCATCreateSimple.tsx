import type { CATToken } from '@greenbtc-network/api';
import { SyncingStatus } from '@greenbtc-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@greenbtc-network/api-react';
import { Back, Flex, Loading, useShowError } from '@greenbtc-network/core';
