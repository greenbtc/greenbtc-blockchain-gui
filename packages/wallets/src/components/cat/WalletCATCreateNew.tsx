...
import { greenBTCToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@greenbtc/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = greenBTCToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New GreenBTC Asset Token Wallet</Trans>
        </Back>
        <Card>
