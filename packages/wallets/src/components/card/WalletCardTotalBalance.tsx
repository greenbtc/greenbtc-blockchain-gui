import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@greenbtc-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@greenbtc-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for GBTC, CATs, or
