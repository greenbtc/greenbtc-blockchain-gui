import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@greenbtc-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@greenbtc-network/core';
import { Reload } from '@greenbtc-network/icons';
