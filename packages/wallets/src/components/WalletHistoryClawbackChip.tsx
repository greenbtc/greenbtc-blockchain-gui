import { TransactionType } from '@greenbtc-network/api';
import type { Transaction } from '@greenbtc-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@greenbtc-network/api-react';
import { useTrans, Button } from '@greenbtc-network/core';
