import { Connection, ServiceConnectionName } from '@greenbtc-network/api';
import { useGetWalletConnectionsQuery } from '@greenbtc-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@greenbtc-network/core';
