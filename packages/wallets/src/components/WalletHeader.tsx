import { useDeleteUnconfirmedTransactionsMutation } from '@greenbtc-network/api-react';
import { Flex, ConfirmDialog, useOpenDialog, DropdownActions, MenuItem } from '@greenbtc-network/core';
...
type StandardWalletProps = {
  walletId: number;
  actions?: ReactNode;
  tab: 'summary' | 'send' | 'receive' | 'nftRecover' | 'staking';
  onTabChange: (tab: 'summary' | 'send' | 'receive' | 'nftRecover' | 'staking') => void;
};
