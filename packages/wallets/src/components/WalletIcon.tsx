import { WalletType, type Wallet } from '@greenbtc-network/api';
import { useGetCatListQuery } from '@greenbtc-network/api-react';
import { Flex, TooltipIcon, useCurrencyCode } from '@greenbtc-network/core';
import { CrCat } from '@greenbtc-network/icons';
